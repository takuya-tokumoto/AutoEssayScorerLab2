...
class Trainer:
    ...
    def train(self, X_train, y_train):
        ...
        self.xgb_regressor.n_estimators = (
            self.best_xgb_iteration + 1
        )  # XGBoost は0ベースのインデックスなので、1を加える
    ...
    def predict(self, X):
        ...
        predicted = None
        predicted = 0.76 * self.light.predict(X) + 0.24 * self.xgb_regressor.predict(X)
